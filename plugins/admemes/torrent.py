...
@Client.on_message(filters.command("prevtorrent(\-(.*))"))
...
@Client.on_message(filters.command("nexttorrent(\-(.*))"))
...
@Client.on_message(filters.command("torrentstop(\-(.*))"))
...
@Client.on_message(filters.command("newtorrent(\-(.*))"))
async def paginate_nexttorrent(event):
    approved_userss = approved_users.find({})
    for ch in approved_userss:
        iid = ch["id"]
